...
export function ptBrFlag(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <mask id="circleFlagsPtBr0">
        <circle cx="256" cy="256" r="256" fill="#fff" />
      </mask>
      <g mask="url(#circleFlagsPtBr0)">
        ...
        <path
          fill="#eee"
          d="M167 284c-9 0-17-8-17-17v-22h34v22c0 9-8 17-17 17"
        />
      </g>
    </svg>
  );
