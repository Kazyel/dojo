...
But for now, whether it's a piece of code, a tip, a rant, or an opinion, I intend to share and save everything here. Initially, for myself, but if anyone happens to take an interest in any post and finds it even minimally useful, I'll be happy about that.
